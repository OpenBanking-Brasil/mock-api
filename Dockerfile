...
OPENAPI_MOCK_DEFAULT_MIN_INT=1
OPENAPI_MOCK_DEFAULT_MAX_INT=10
OPENAPI_MOCK_DEFAULT_MIN_FLOAT=1.00
OPENAPI_MOCK_DEFAULT_MAX_FLOAT=1.073
OPENAPI_MOCK_NULL_PROBABILITY=1.0
ENV OPENAPI_MOCK_USE_EXAMPLES=if_present
